...
public class DirtBoxMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DirtBoxMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MountainsPoemModMenus.DIRT_BOX.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 70, 26) {
