...
public class NewjiangforestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<NewjiangforestTrunkDecorator> CODEC = Codec.unit(NewjiangforestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("newjiangforest_tree_trunk_decorator", DECORATOR_TYPE));
	}
