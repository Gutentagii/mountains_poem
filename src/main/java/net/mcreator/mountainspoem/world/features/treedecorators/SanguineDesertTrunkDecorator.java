...
public class SanguineDesertTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SanguineDesertTrunkDecorator> CODEC = Codec.unit(SanguineDesertTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("sanguine_desert_tree_trunk_decorator", DECORATOR_TYPE));
	}
