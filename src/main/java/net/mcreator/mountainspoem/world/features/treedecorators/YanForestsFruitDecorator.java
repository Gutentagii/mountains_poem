...
public class YanForestsFruitDecorator extends CocoaDecorator {
	public static Codec<YanForestsFruitDecorator> CODEC = Codec.unit(YanForestsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("ancient_battlefields_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public YanForestsFruitDecorator() {
		super(0.2f);
	}
