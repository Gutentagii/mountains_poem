...
import net.mcreator.mountainspoem.procedures.RingHead5Procedure;

public class NetheriteRingHeadKnifeItem extends SwordItem {
	public NetheriteRingHeadKnifeItem() {
		super(new Tier() {
			public int getUses() {
				return 2123;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		RingHead5Procedure.execute(entity);
	}
}
