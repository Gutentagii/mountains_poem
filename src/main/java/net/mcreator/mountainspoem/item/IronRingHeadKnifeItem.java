...
import net.mcreator.mountainspoem.procedures.RingHead8Procedure;

public class IronRingHeadKnifeItem extends SwordItem {
	public IronRingHeadKnifeItem() {
		super(new Tier() {
			public int getUses() {
				return 276;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		RingHead8Procedure.execute(entity);
	}
}
