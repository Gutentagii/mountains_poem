...
import net.mcreator.mountainspoem.procedures.RawLufishWuPinZaiBeiBaoZhongShiMeiKeFaShengProcedure;
import net.mcreator.mountainspoem.procedures.RawLufishWanJiaWanChengShiYongWuPinShiProcedure;

public class RawLufishItem extends Item {
	public RawLufishItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		RawLufishWuPinZaiBeiBaoZhongShiMeiKeFaShengProcedure.execute(entity);
	}
}
