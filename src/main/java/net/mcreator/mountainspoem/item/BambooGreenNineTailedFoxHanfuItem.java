...
import net.mcreator.mountainspoem.client.renderer.BambooGreenNineTailedFoxHanfuArmorRenderer;

import java.util.Objects;
import java.util.function.Consumer;
import java.util.List;

public class BambooGreenNineTailedFoxHanfuItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public BambooGreenNineTailedFoxHanfuItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public @NotNull String getName() {
				return "bamboo_green_nine_tailed_fox_hanfu";
			}
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new BambooGreenNineTailedFoxHanfuArmorRenderer();
