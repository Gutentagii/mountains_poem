...
import net.mcreator.mountainspoem.procedures.ThrowersProcedure;

import java.util.List;

public class ThrowerArmorTrimSmithingTemplateItem extends Item {
	public ThrowerArmorTrimSmithingTemplateItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("mountains_poem:thrower_armor_trim_smithing_template_dscr"));
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		ThrowersProcedure.execute(entity);
	}
}
