...
public class MooncakeCentipedeGetRecipeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof ServerPlayer _serverPlayer)
			_serverPlayer.awardRecipesByKey(new ResourceLocation[]{new ResourceLocation("mountains_poem:item_mooncake_centipede_recipe")});
		if (entity instanceof ServerPlayer _serverPlayer)
			_serverPlayer.awardRecipesByKey(new ResourceLocation[]{new ResourceLocation("mountains_poem:item_mooncake_centipede_recipe_2")});
