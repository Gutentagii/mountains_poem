...
import net.mcreator.mountainspoem.item.model.UnderIronModel;
import net.mcreator.mountainspoem.item.UnderIronItem;

public class UnderIronArmorRenderer extends GeoArmorRenderer<UnderIronItem> {
	public UnderIronArmorRenderer() {
		super(new UnderIronModel());
	...
	@Override
	public RenderType getRenderType(UnderIronItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
