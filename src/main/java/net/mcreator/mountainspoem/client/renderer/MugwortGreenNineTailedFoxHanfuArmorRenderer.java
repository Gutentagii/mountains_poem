...
import net.mcreator.mountainspoem.item.model.MugwortGreenNineTailedFoxHanfuModel;
import net.mcreator.mountainspoem.item.MugwortGreenNineTailedFoxHanfuItem;

public class MugwortGreenNineTailedFoxHanfuArmorRenderer extends GeoArmorRenderer<MugwortGreenNineTailedFoxHanfuItem> {
	public MugwortGreenNineTailedFoxHanfuArmorRenderer() {
		super(new MugwortGreenNineTailedFoxHanfuModel());
	...
	@Override
	public RenderType getRenderType(MugwortGreenNineTailedFoxHanfuItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
