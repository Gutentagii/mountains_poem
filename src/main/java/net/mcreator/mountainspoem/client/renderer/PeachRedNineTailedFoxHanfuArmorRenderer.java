...
import net.mcreator.mountainspoem.item.model.PeachRedNineTailedFoxHanfuModel;
import net.mcreator.mountainspoem.item.PeachRedNineTailedFoxHanfuItem;

public class PeachRedNineTailedFoxHanfuArmorRenderer extends GeoArmorRenderer<PeachRedNineTailedFoxHanfuItem> {
	public PeachRedNineTailedFoxHanfuArmorRenderer() {
		super(new PeachRedNineTailedFoxHanfuModel());
	...
	@Override
	public RenderType getRenderType(PeachRedNineTailedFoxHanfuItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
