...
import net.mcreator.mountainspoem.procedures.CopperDouChangfuYouJiProcedure;
import net.mcreator.mountainspoem.block.entity.CopperDouChangfuChickenSauceBlockEntity;

public class CopperDouChangfuChickenSauceBlock extends Block implements EntityBlock {
	public static final IntegerProperty BLOCKSTATE = IntegerProperty.create("blockstate", 0, 2);
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public CopperDouChangfuChickenSauceBlock() {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		CopperDouChangfuYouJiProcedure.execute(world, x, y, z, blockstate, entity);
	...
	public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
		return new CopperDouChangfuChickenSauceBlockEntity(pos, state);
	}
