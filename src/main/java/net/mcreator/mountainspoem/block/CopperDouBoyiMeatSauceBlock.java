...
import net.mcreator.mountainspoem.procedures.CopperDouBoyiMeatSauceYouJiProcedure;
import net.mcreator.mountainspoem.block.entity.CopperDouBoyiMeatSauceBlockEntity;

public class CopperDouBoyiMeatSauceBlock extends Block implements EntityBlock {
	public static final IntegerProperty BLOCKSTATE = IntegerProperty.create("blockstate", 0, 2);
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public CopperDouBoyiMeatSauceBlock() {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		CopperDouBoyiMeatSauceYouJiProcedure.execute(world, x, y, z, blockstate, entity);
	...
	public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
		return new CopperDouBoyiMeatSauceBlockEntity(pos, state);
	}
